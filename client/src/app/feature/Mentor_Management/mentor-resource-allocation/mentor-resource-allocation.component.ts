...
@Component({
  selector: 'app-mentor-resource-allocation',
  templateUrl: './mentor-resource-allocation.component.html',
  styleUrls: ['./mentor-resource-allocation.component.css']
})
export class MentorResourceAllocationComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.assignedTrainees(this.page,this.limit,this.mentorId);
  ...
  assignedTrainees(page: any, limit: any,mentorId:any,searchTrainee?:any) {
    ...
    this.mentorResource
      .assignedResources(page,limit,this.mentorId,this.searchUser.value.searchAssigned)
      .subscribe({
        next: (resp: any) => {
          this.submitted = true;
  ...
  totalTrainees(page: any, limit: any, searchMgr?: any) {
    ...
    this.mentorResource.unassignedResources(page,limit,this.searchUser.value.searchUnassigned).subscribe({
      next: (resp: any) => {
        this.submitted = true;
  ...
  allocateTrainees() {
    ...
    this.submitted=true;
    this.mentorResource
      .allocateResources(1, this.mentorId, param)
      .subscribe({
        next: (resp: any) => {
  ...
  deallocateTrainees() {
    ...
    this.submitted=true;
    this.mentorResource
      .deallocateResources(0, this.mentorId, param)
      .subscribe({
        next: (resp: any) => { 
